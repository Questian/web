    ...
    <section id="left-container">
        ...
        if (isset($_POST['submit-quest'])) {
            ...
            if(!empty($quest) && !empty($reward) && !empty($content)) {
                ...
                $user = new Users('uid', 'token');
                $quest = new Quest(0, $quest, $reward, $content, $latitude, $longtitude, $img);
                $result = $user->request($quest);
                if($result) echo "퀘스트를 공표했습니다.";
                else echo "퀘스트를 공표하는데 실패했습니다.";
            ...
            <div class="box-model quest-request">
                <div class="quest-card-padding-wrapper request-box">
                    <article class="quest-card-article">
                        ...
                        <textarea class="quest-content" name="content" placeholder="무엇이 필요하신가요?" form="request-form"></textarea>
